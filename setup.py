...
kwargs = dict(
    ...
    entry_points={
        "console_scripts": [
            "moon = chia.cmds.chia:main",
            "moon_daemon = chia.daemon.server:main",
            "moon_wallet = chia.server.start_wallet:main",
            "moon_full_node = chia.server.start_full_node:main",
            "moon_harvester = chia.server.start_harvester:main",
            "moon_farmer = chia.server.start_farmer:main",
            "moon_introducer = chia.server.start_introducer:main",
            "moon_crawler = chia.seeder.start_crawler:main",
            "moon_seeder = chia.seeder.dns_server:main",
            "moon_timelord = chia.server.start_timelord:main",
            "moon_timelord_launcher = chia.timelord.timelord_launcher:main",
            "moon_full_node_simulator = chia.simulator.start_simulator:main",
            "moon_data_layer = chia.server.start_data_layer:main",
            "moon_data_layer_http = chia.data_layer.data_layer_server:main",
        ]
    },
    package_data={
